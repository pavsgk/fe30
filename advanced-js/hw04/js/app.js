...
import {q, generateLiList} from './utils.js';
cache.initLocal();
...
const showFilm = async ({episodeId, name, openingCrawl}, targetElm) => {
  const HTMLString = `
    <div class="film-card">
  ...
  targetElm.insertAdjacentHTML('beforeEnd', HTMLString);
}

console.log(document.q('test'));
